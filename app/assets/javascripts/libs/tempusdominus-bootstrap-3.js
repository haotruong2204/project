...
var DateTimePicker = function ($, moment) {
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype.useCurrent = function useCurrent(_useCurrent) {
            var useCurrentOptions = ['year', 'month', 'day', 'hour', 'minute', 'roundedmin'];
            if (arguments.length === 0) {
    ...
    var TempusDominusBootstrap3 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap3.prototype.show = function show() {
            ...
            var useCurrentGranularity = {
                ...
                'roundedMin': function rounded(m) {
                    var roundedDate = new Date(m.toDate()).roundedMinuteTo(this.roundedMinTo);
